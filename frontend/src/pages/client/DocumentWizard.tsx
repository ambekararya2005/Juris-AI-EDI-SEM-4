...
const DOC_TYPE_API_MAP: Record<string, string> = {
  ...
  'Business Agreement': 'business_agreement',
...
const DocumentWizard: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setGeneratedContent(response.content || BAIL_APPLICATION_CONTENT);
      ...
      setGeneratedContent(BAIL_APPLICATION_CONTENT);
    } finally {
      setGenerating(false);
    }
  };
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 mb-6">
                ...
                <div className="lg:col-span-3 bg-surface-gray dark:bg-slate-900 rounded-xl p-5 font-mono text-xs leading-relaxed text-dark-text dark:text-slate-200 max-h-96 overflow-y-auto border border-border dark:border-slate-700">
                  ...
                  <pre className="whitespace-pre-wrap font-mono text-xs">{generatedContent}</pre>
                </div>
