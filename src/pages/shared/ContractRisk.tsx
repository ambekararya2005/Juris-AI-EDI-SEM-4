...
const ContractRisk: React.FC = () => {
  ...
  // Map first item (r1) to CRITICAL to satisfy 4 levels requirement, keeping the rest
  const processedFlags = mockRiskFlags.map(flag => ({
    ...flag,
    severity: flag.id === 'r1' ? 'CRITICAL' : flag.severity,
  }));
